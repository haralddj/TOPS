def load():
    return {
        ...
        'gov': {
            ...
            #     ['HYGOV1', 'G1', 0.14, 1.9, 0.05,  8,    0.6,     1,    5.3,   0.01,   0.01,      0,     0.15,     1,       0],
            #     ['HYGOV2', 'G2', 0.14, 1.9, 0.05,  8,    0.6,     1,    5.3,   0.01,   0.01,      0,     0.15,     1,       0],
            #     ['HYGOV3', 'G3', 0.14, 1.9, 0.05,  8,    0.6,     1,    5.3,   0.01,   0.01,      0,     0.15,     1,       0],
            #     ['HYGOV4', 'G4', 0.14, 1.9, 0.05,  8,    0.6,     1,    5.3,   0.01,   0.01,      0,     0.15,     1,       0],
            # ]
        },
        ...
        'pss': {
            'STAB1': [
                ...
                ['PSS1',    'G1',   1,     10.0,   0.5,    0.5,    0.05,   0.05,   0.03],
                ['PSS2',    'G2',   1,     10.0,   0.5,    0.5,    0.05,   0.05,   0.03],
                ['PSS3',    'G3',   1,     10.0,   0.5,    0.5,    0.05,   0.05,   0.03],
                ['PSS4',    'G4',   1,     10.0,   0.5,    0.5,    0.05,   0.05,   0.03],
            ]
        },
    }