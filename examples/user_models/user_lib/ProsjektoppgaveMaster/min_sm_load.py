...
def load():
    return {
        ...
        'gov': {
            'HYGOV': [#navn, generator, Permanent droop, temproary droop, filter timeC, washout timec, servo timec,idk,water intertia timec, idk, damping, ,
                    ['name',  'gen',    'R',    'r',    'T_f', 'T_r',  'T_g', 'A_t',     'T_w', 'q_nl', 'D_turb', 'g_min',     'V_elm',      'g_max', 'P_N'],
                    ['HYGOV1', 'G1',    0.1,   1.5,      0.05,     5,    0.1,      1,       8,   0.01,    0.01,      0,          0.15,        1,      0],
                    ]
        },
    }