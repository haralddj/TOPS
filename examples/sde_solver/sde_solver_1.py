...
from examples.user_models.user_lib.MyTools.Statistics import *
...
if __name__ == '__main__':
    ...
    model['loads'] = {'DynamicLoadFiltered':  [#model['loads']}
        ...
        *[row + [50, 50] for row in model['loads'][1:]]
    ]}
...
### Frekvens fra peltondata ###
    ...
    freq2 = data['Frequency [Hz*4]'][2:15000]/4
    time2 = data['Time [s]'][2:15000]
###Frekvens fra peltondata ###
    ###Autocorrelation###
    ...
    ax[3].plot(res['time'], avg_freq, label='Simulation')
    ax[3].set_ylabel('Frequency [Hz]')
    ax[3].plot(time2, freq2, label='Real data')
