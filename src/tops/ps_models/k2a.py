    ...
    return {
        ...
        'gov': {
            ...
            'HYGOV': [
                ...
                ['HYGOV1', 'G1', 0.14, 1, 0.05,  8,    0.6,     1,    5.3,   0.01,   0.01,      0,     0.15,     1,       0],
                ['HYGOV2', 'G2', 0.14, 1, 0.05,  8,    0.6,     1,    5.3,   0.01,   0.01,      0,     0.15,     1,       0],
                ['HYGOV3', 'G3', 0.14, 1, 0.05,  8,    0.6,     1,    5.3,   0.01,   0.01,      0,     0.15,     1,       0],
                ['HYGOV4', 'G4', 0.14, 1, 0.05,  8,    0.6,     1,    5.3,   0.01,   0.01,      0,     0.15,     1,       0],
            ]
        },
        ...
        'avr': {
            'SEXS': [
                ...
                ['AVR1',    'G1',      200,    2.0,    10.0,   0.5,    -3,         3],
                ['AVR2',    'G2',      200,    2.0,    10.0,   0.5,    -3,         3],
                ['AVR3',    'G3',      200,    2.0,    10.0,   0.5,    -3,         3],
                ['AVR4',    'G4',      200,    2.0,    10.0,   0.5,    -3,         3],
            ]
        },
